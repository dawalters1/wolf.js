...
module.exports = class Client {
  constructor (api, targetGroupId) {
    ...
    this._client.onconnectionstatechanged = () => {
      // TODO: handle states
    };
  ...
  async _broadcast () {
    ...
    this._samples = this._samples.slice(samples.length);
    ...
    return await this._source.onData({
      samples,
