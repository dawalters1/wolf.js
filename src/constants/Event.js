...
export const CONNECTION_ERROR = 'connectError';
...
export const CHANNEL_ROLE_SUBSCRIBER_ASSIGN = 'channelRoleSubsciberAssign';
export const CHANNEL_ROLE_SUBSCRIBER_UNASSIGN = 'channelRoleSubscriberUnassign';
...
export const PACKET_RECEIVED = 'packetReceived';
export const PACKET_SENT = 'packetSent';
export const PACKET_FAILED = 'packetFailed';
export const PACKET_RETRY = 'packetRetry';
export const PING = 'ping';
export const PONG = 'pong';
export const PRESENCE_UPDATE = 'presenceUpdate';
export const PRIVATE_MESSAGE = 'privateMessage';
export const PRIVATE_MESSAGE_ACCEPT_RESPONSE = 'privateMessageAcceptResponse';
export const PRIVATE_MESSAGE_UPDATE = 'privateMessageUpdate';
export const PRIVATE_TIP_ADD = 'privateTipAdd';
...
export default {
  ...
  PRESENCE_UPDATE,
  PRIVATE_MESSAGE,
  PRIVATE_MESSAGE_ACCEPT_RESPONSE,
