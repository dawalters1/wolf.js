...
export const Command = {
  ...
  SUBSCRIBER_FOLLOW_ADD: 'subscriber follow add',
  SUBSCRIBER_FOLLOW_DELETE: 'subscriber follow delete',
  SUBSCRIBER_FOLLOW_UPDATE: 'subscriber follow update',
  SUBSCRIBER_FOLLOW_COUNT: 'subscriber follow count',
  SUBSCRIBER_FOLLOWER_COUNT: 'subscriber follower count',
  SUBSCRIBER_FOLLOW_LIST: 'subscriber follow list',
  SUBSCRIBER_FOLLOWER_LIST: 'subscriber follower list',
