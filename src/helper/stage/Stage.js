  ...
  async setVolume(targetGroupId, volume) {
    try {
      ...
      if (validator.isNullOrUndefined(volume)) {
        ...
        throw new Error('volume cannot be less than 0');
      }
      ...
      error.internalErrorMessage = `api.stage().setVolume(targetGroupId=${JSON.stringify(targetGroupId)}, volume=${JSON.stringify(volume)})`;
      throw error;
    }
  }
