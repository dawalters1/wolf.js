...
const developerConfig = (client) => {
  ...
  client.config = {
    ...
    ***REMOVED*** {
        events: {
        ***REMOVED*** typeof config?.framework?.subscriptions?.events?.subscriptions === 'boolean' ? config.framework.subscriptions.events.subscriptions : true,
      ...
      ***REMOVED*** {
        ...
        ***REMOVED*** typeof config?.framework?.subscriptions?.messages?.group?.tipping === 'boolean' ? config.framework.subscriptions.messages.group.tipping : true
          },
          private: {
