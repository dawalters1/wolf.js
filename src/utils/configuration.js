  ...
  client.config = {
    ...
    ***REMOVED*** {
      ***REMOVED*** {
        ...
        ***REMOVED*** typeof config?.framework?.subscriptions?.messages?.group?.tipping === 'boolean' || typeof config?.framework?.subscriptions?.messages?.channel?.tipping === 'boolean' ? config.framework.subscriptions.messages.group?.tipping ?? config.framework.subscriptions.messages.channel.tipping : true
          },
    ***REMOVED*** {
            enabled: typeof config?.framework?.subscriptions?.messages?.group?.enabled === 'boolean' || typeof config?.framework?.subscriptions?.messages?.channel?.enabled === 'boolean' ? config.framework.subscriptions.messages.group?.enabled ?? config.framework.subscriptions.messages.channel.enabled : true,
        ***REMOVED*** typeof config?.framework?.subscriptions?.messages?.group?.tipping === 'boolean' || typeof config?.framework?.subscriptions?.messages?.channel?.tipping === 'boolean' ? config.framework.subscriptions.messages.group?.tipping ?? config.framework.subscriptions.messages.channel.tipping : true
