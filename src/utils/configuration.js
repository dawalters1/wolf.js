...
const developerConfig = (client) => {
  ...
  client.config = {
    ...
    ***REMOVED*** {
      ...
      login: {
    ***REMOVED***typeof config?.framework?.login?.email === 'string' ? config.framework.login.email : undefined,
    ***REMOVED***typeof config?.framework?.login?.password === 'string' ? config.framework.login.password : undefined,
    ...
    ***REMOVED*** {
      ...
      ***REMOVED*** typeof config?.framework?.commands?.ignore?.unofficial === 'boolean' ? config.framework.commands.ignore.unofficial : false,
    ...
    ***REMOVED*** {
      ***REMOVED*** {
          group: {
            enabled: typeof config?.framework?.subscriptions?.messages?.group?.enabled === 'boolean' ? config.framework.subscriptions.messages.channel.enabled : true,
        ***REMOVED*** typeof config?.framework?.subscriptions?.messages?.group?.tipping === 'boolean' ? config.framework.subscriptions.messages.channel.tipping : true
          },
          private: {
        ...
        ***REMOVED*** typeof config?.framework?.subscriptions?.messages?.private?.tipping === 'boolean' ? config.framework.subscriptions.messages.private.tipping : false
          }
        }
      }
    },
